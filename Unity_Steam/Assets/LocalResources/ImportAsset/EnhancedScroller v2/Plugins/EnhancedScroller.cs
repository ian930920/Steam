...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler
    {
        ...
        {
            get { return isScrolling; } private set { isScrolling = value;
                if (value) { if (OnScrollingStart != null) OnScrollingStart(); } else { if (OnScrollingEnd != null) OnScrollingEnd(); } }
        }
        public Action OnScrollingStart;
        public Action OnScrollingEnd;
        ...
        public void InactiveCellViews()
        {
            ...
            {
                _activeCellViews[i].StopAllCoroutines();
            }
        }
        #endregion
